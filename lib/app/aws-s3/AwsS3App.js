...
class AwsS3App extends AwsAppController_1.AwsAppController {
    ...
    saveOutput(stream, shell, options) {
        return __awaiter(this, void 0, void 0, function* () {
            // output 
            const bucket_id = yield this.getOutput(stream, shell, 'bucket_id');
            const bucket_domain_name = yield this.getOutput(stream, shell, 'bucket_domain_name');
            // save
    ...
    list(kind) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const domain = {
                kind: 'domain',
                name: options.identifier,
                entrypoints: [info === null || info === void 0 ? void 0 : info.bucket_domain_name],
                // servicePort: 80,
                status: 'bound',
            };
    ...
    getStat() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rds = {
                ...
                dimensionValue: info === null || info === void 0 ? void 0 : info.bucket_id,
