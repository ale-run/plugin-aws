...
class AwsECSApp extends AwsAppController_1.AwsAppController {
    ...
    list(kind) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newTask = yield this.ecsApi.describeTask(options.region, options.clusterName, options.serviceName);
            info.task = newTask || info.task;
            const task = info.task;
            logger.debug(`[LIST]`, this.request);
            logger.debug(`[LIST]info.task`, info === null || info === void 0 ? void 0 : info.task);
            // workload
            const workload = {
                kind: 'workload',
