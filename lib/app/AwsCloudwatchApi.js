...
class AwsCloudwatchApi {
    ...
    getCPUUtilization(statObject, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const input = this.getCommandInput('CPUUtilization', [client_cloudwatch_1.Statistic.Average], statObject, options);
            const datapoints = yield this.getMetricStatistics(statObject.region, input);
            return this.toMetricData(statObject.identifier, datapoints);
        });
    }
    ...
    getNetworkIn(statObject, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const input = this.getCommandInput('NetworkIn', [client_cloudwatch_1.Statistic.Sum], statObject, options);
            const datapoints = yield this.getMetricStatistics(statObject.region, input);
            return this.toMetricData(statObject.identifier, datapoints);
        });
    }
    ...
    getNetworkOut(statObject, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const input = this.getCommandInput('NetworkOut', [client_cloudwatch_1.Statistic.Sum], statObject, options);
            const datapoints = yield this.getMetricStatistics(statObject.region, input);
            return this.toMetricData(statObject.identifier, datapoints);
        });
    }
