...
class AwsECSApp extends AwsAppController_1.AwsAppController {
    ...
    readOptions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let subnetIds = subnets ? subnets.trim().split(',') : (_f = (_e = this.plugin) === null || _e === void 0 ? void 0 : _e.options) === null || _f === void 0 ? void 0 : _f.SUBNET_IDS;
            const publicSubnets = this.request.options.publicSubnetIds;
            let publicSubnetIds = publicSubnets ? publicSubnets.trim().split(',') : (_h = (_g = this.plugin) === null || _g === void 0 ? void 0 : _g.options) === null || _h === void 0 ? void 0 : _h.PUBLIC_SUBNET_IDS;
            ...
            let env = (_j = this.request.options) === null || _j === void 0 ? void 0 : _j.env;
            let environments = [];
            if (env) {
                environments = env;
            }
            ...
            if (prevOptions) {
                ...
                publicSubnetIds = prevOptions === null || prevOptions === void 0 ? void 0 : prevOptions.publicSubnetIds;
            ...
            if (!subnetIds)
                throw new Error(`options 'Subnet IDs' is required`);
            if (!publicSubnetIds)
                throw new Error(`options 'Public Subnet IDs' is required`);
            if (!clusterName)
                throw new Error(`options 'Cluster Name' is required`);
            if (!containerName)
                throw new Error(`options 'Container Name' is required`);
            if (!containerImage)
                throw new Error(`options 'Container Image' is required`);
            if (!containerPort)
                throw new Error(`options 'Container Port' is required`);
            if (volumes && volumes.length > 0 && !efsName)
                throw new Error(`options 'EFS Name' is required when using volumes`);
            const options = {
                region,
                vpcId,
                subnetIds,
    ...
    list(kind) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // volume
            const mountPoints = (_e = taskDefinition === null || taskDefinition === void 0 ? void 0 : taskDefinition.containerDefinitions) === null || _e === void 0 ? void 0 : _e[0].mountPoints;
    ...
    getStat() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loadBalancer = match === null || match === void 0 ? void 0 : match[1];
            const statObject = {
